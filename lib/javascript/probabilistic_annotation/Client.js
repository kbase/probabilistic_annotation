...
function ProbabilisticAnnotation(url, auth, auth_cb) {
    ...
    this.annotation_probabilities_id = function(input)
    {
        var resp = json_call_ajax_sync("ProbabilisticAnnotation.annotation_probabilities_id", [input]);

        return resp[0];
    }

    this.annotation_probabilities_id_async = function(input, _callback, _error_callback)
    {
        json_call_ajax_async("ProbabilisticAnnotation.annotation_probabilities_id", [input], 1, _callback, _error_callback)
    }

    this.calculate = function(input)
    {
        var resp = json_call_ajax_sync("ProbabilisticAnnotation.calculate", [input]);
    ...
    {
        json_call_ajax_async("ProbabilisticAnnotation.calculate", [input], 1, _callback, _error_callback)
    }

    this.normalize = function(input)
    {
        var resp = json_call_ajax_sync("ProbabilisticAnnotation.normalize", [input]);

        return resp[0];
    }

    this.normalize_async = function(input, _callback, _error_callback)
    {
        json_call_ajax_async("ProbabilisticAnnotation.normalize", [input], 1, _callback, _error_callback)
    }

    this.generate_data = function(input)
    {
        var resp = json_call_ajax_sync("ProbabilisticAnnotation.generate_data", [input]);

        return resp[0];
    }

    this.generate_data_async = function(input, _callback, _error_callback)
    {
        json_call_ajax_async("ProbabilisticAnnotation.generate_data", [input], 1, _callback, _error_callback)
    }

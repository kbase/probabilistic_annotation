...
function ProbabilisticAnnotation(url, auth, auth_cb) {
    ...
    this.annotate = function(input)
    {
        var resp = json_call_ajax_sync("ProbabilisticAnnotation.annotate", [input]);
    ...
    {
        json_call_ajax_async("ProbabilisticAnnotation.annotate", [input], 1, _callback, _error_callback)
    }

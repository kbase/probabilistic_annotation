package probabilistic_annotationServer;
...
sub call_method {
    ...
    my $ctx = probabilistic_annotationServerContext->new(client_ip => $self->_plack_req->address);
...
package probabilistic_annotationServerContext;

use strict;

=head1 NAME

probabilistic_annotationServerContext
